...
/**
 * This is the model class for table "tblcondiciones".
 *
 * The followings are the available columns in table 'tblcondiciones':
...
class Condiciones extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idCondicion, nombre, estado', 'safe', 'on'=>'search'),
		);
	}
